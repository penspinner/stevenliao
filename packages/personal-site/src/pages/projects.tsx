...
export const Projects = <TLogo,>({
  ...
  return (
    <SimpleLayout
      ...
      intro="Here are some of my projects over the years. It's mostly my old personal sites and me trying to practice data structures and algorithmic challenges."
    >
